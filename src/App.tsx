              ...
              <div style={{ position: 'relative', display: 'grid', gridTemplateColumns: '60px 1fr' }}>
                ...
                <div style={{ position: 'relative', borderLeft: '1px solid #e2e2e2' }}>
                  ...
                  {bookingHour !== null && bookingAvailableUntil !== null && (
                    <div aria-hidden="true" style={{ position: 'absolute', top: (bookingHour - HOUR_START) * ROW_HEIGHT, height: (bookingAvailableUntil - bookingHour) * ROW_HEIGHT - 2, left: 2, right: 2, background: '#E0E6E7', color: '#000', borderRadius: 3, padding: '6px 8px', fontSize: 11, lineHeight: 1.4, overflow: 'hidden', pointerEvents: 'none', zIndex: 2 }}>
